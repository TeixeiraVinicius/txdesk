      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Adicionar Chamado</li>
          </ol>
          ...
          <div class="multisteps-form mb-5">
            ...
            <div class="row">
              <div class="col-12 col-lg-8 m-auto">
                <form class="multisteps-form__form mb-8" method="post" action="{{route('salvar.chamados')}}" >
                @csrf
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    ...
                    <div class="multisteps-form__content">
                      <div class="row mt-3">
                        <div class="col-12 col-sm-6">
                          <label>Cliente</label>
                          <input class="multisteps-form__input form-control" type="text" placeholder="Nome do Cliente" name="nome"/>
                        </div>
                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                          <label>Número do Pedido</label>
                          <input class="multisteps-form__input form-control" type="text" placeholder="Pedido de Compra" name="pedido" />
                        </div>
                      </div>
                      <div class="row mt-3">
                        <div class="col-12 col-sm-6">
                        <label >Loja</label>
                             ...
                             <option >- Escolha a Loja -</option>
                              <option value="Bedstore Park Shopping">Bedstore Park Shopping</option>
                              <option value="Bedstore Madureira Shopping">Bedstore Madureira Shopping</option>
                              <option value="Sealy Park Shopping">Sealy Park Shopping</option>
                              <option value="Sealy Américas Shopping">Sealy Américas Shopping</option>
                             </select>
                        </div>
                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                      ...
                      <div class="row mt-3">
                        <div class="col-12 col-sm-6">
                          <label>Produto</label>
                          <input class="multisteps-form__input form-control" type="text" placeholder="Ex.: Magnum 138x188" name="produto" />
                        </div>
                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                          <label>Data da Compra</label>
                          <input class="multisteps-form__input form-control" type="date" name="datacompra" />
                        </div>
                      </div>
                    ...
                    <div class="multisteps-form__content">
                      <div class="row mt-3 ">
                        ...
                        <div class="col-12 col-sm-6">
                          ...
                          <input class="multisteps-form__input form-control" type="date" name="datavistoria"/>
                        </div>
                      </div>
                      <div class="row mt-3">
                      <div class="col-12 col-sm-12">
                          ...
                          <select class="form-control" name="sla" >
                             <option >- Escolha a SLA -</option>
                              <option value="Crítica">Crítica</option>
                              <option value="Muita Alta">Muita Alta</option>
                  ...
                  <!--single form panel-->
                  <div class="card multisteps-form__panel p-3 border-radius-xl bg-white" data-animation="FadeIn">
                    <h5 class="font-weight-bolder">Ocorrência</h5>
                    <div class="multisteps-form__content">
                      <div class="row mt-3">
                        <div class="col-12">
                          <textarea class ="multisteps-form__textarea form-control" name="ocorrencia"  cols="30" rows="10"></textarea>
                        </div>
                  ...
                  <div class="card multisteps-form__panel p-3 border-radius-xl bg-white h-100" data-animation="FadeIn">
                    <div class="multisteps-form__content mt-3">
                      ...
                      <div class="col-12 mt-3">
                          ...
                          <textarea class="multisteps-form__textarea form-control" rows="5" name="parecer"></textarea>
                        </div>
                        <div class="row mt-3 ">
                        <div class="col-12 col-sm-6">
                          <label>Resolução</label>
                          <select class="form-control" name="resolucao" >
                             <option >- Escolha a Resolução -</option>
                              <option value="Trocar por mesmo produto">Trocar por mesmo produto</option>
                              <option value="Trocar por produto diferente">Trocar por produto diferente</option>
                              <option value="Garantia com fabricante">Garantia com fabricante</option>
                              <option value="Nada a fazer">Nada a fazer</option>
                             </select>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                          ...
                          <select class="form-control" name="status" >
                            <option >- Escolha o Status -</option>
                              ...
                              <option value="Arguardando compra">Arguardando compra</option>
                              <option value="Aguardando troca">Aguardando troca</option>
