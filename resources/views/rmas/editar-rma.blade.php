      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Editar RMA</li>
          </ol>
          ...
          <div class="multisteps-form mb-5">
            ...
            <div class="row">
              <div class="col-12 col-lg-8 m-auto">
                <form class="multisteps-form__form mb-8" method="post" action="{{route('atualizar.rmas', $id)}}" >
                ...
                <input name="_method" type="hidden" value="put">
                    ...
                    <div class="multisteps-form__content">
                      <div class="row mt-3">
                        <div class="col-12 col-sm-6">
                          <label>Produto</label>
                          <input class="multisteps-form__input form-control" type="text" value="{{$rma->produto}}" name="produto"/>
                        </div>
                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                          <label>Fabricante</label>
                          <input class="multisteps-form__input form-control" type="text" value="{{$rma->fabricante}}" name="fabricante" />
                        </div>
                      </div>
                      <div class="row mt-3">
                        <div class="col-12 col-sm-6">
                        ...
                        <select class="form-control" name="status" >
                              <option value="Aberto" @if ($rma->status == 'Aberto') selected="selected" @endif>Aberto</option>
                              <option value="Em Atendimento" @if ($rma->status == 'Em Atendimento') selected="selected" @endif>Em Atendimento</option>
                              <option value="Enviado ao Fabricante" @if ($rma->status == 'Enviado ao Fabricante') selected="selected" @endif>Enviado ao Fabricante</option>
                              <option value="Retornando ao Depósito" @if ($rma->status == 'Aguardando troca') selected="selected" @endif>Retornando ao Depósito</option>
                              <option value="Concluído" @if ($rma->status == 'Concluído') selected="selected" @endif>Concluído</option>
                             </select>
                        </div>
                       
                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                          <label>Data da Compra</label>
                          <input class="multisteps-form__input form-control" type="date"  value="{{$rma->datacompra}}"/>
                        </div>
                      ...
                      <div class="row mt-3">
                        <div class="col-12 col-sm-6">
                          ...
                          <input class="multisteps-form__input form-control" type="text" value="{{$rma->nf}}" />
                        </div>
                      </div>
                  ...
                  <div class="card multisteps-form__panel p-3 border-radius-xl bg-white" data-animation="FadeIn">
                    ...
                    <div class="multisteps-form__content">
                      <div class="row mt-3">
                        <div class="col-12">
                          <textarea class ="multisteps-form__textarea form-control" name="observacao"   cols="30" rows="10">{{$rma->observacao}}</textarea>
                        </div>
